...
when 'development'
  ...
  100.times do
    Worker.create(
      ...
      date_of_birth: Faker::Date.between(from: 64.years.ago, to: 23.years.ago),
      place_of_birth: Faker::Address.city,
      home_adress: Faker::Address.full_address,
      date_of_hired: Faker::Date.between(from: 5.years.ago, to: (Time.zone.today - 1))
    )
  end
  ...
  300.times do
    WorkerPosition.create(
      ...
      end_date: Faker::Date.between(from: 5.months.ago, to: 1.month.ago)
    )
  end
  ...
  worker_with_department_ids.each do |worker_with_department_id|
    Vacation.create(
      ...
      start_date: Faker::Date.between(from: 2.months.ago, to: Time.zone.today),
